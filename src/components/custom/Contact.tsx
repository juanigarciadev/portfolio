...
const Contact = () => {
    ...
    return (
        <section className="relative flex flex-col gap-8 w-full py-64 xl:px-16 lg:px-8 sm:px-2 md:py-32">
            ...
            <div className="flex flex-col gap-4 items-center">
                <a href="mailto:juanigarciadev" className="relative inline-flex h-12 overflow-hidden rounded p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                    ...
                    <span className="inline-flex gap-2 h-full w-full cursor-pointer items-center justify-center rounded bg-black px-8 py-2 font-semibold text-white backdrop-blur-3xl hover:bg-light transition-all md:text-xs"><Mail />Send me an email</span>
                </a>
                ...
                <div className="flex items-center gap-2 font-light w-fit border border-cardBorder bg-light rounded px-8 py-2">
                    <span className="font-semibold cursor-default select-none md:text-xs">Copy my email address</span>
                    <div>
                        {copy ? (
                            <div>
